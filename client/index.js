  ...
  angular.module('hapi-auth', ['ui.router', 'angularFileUpload'])
    .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider){
      ...
      $stateProvider
        ...
        .state('gradebook',       {url:'/courses/{courseId}/gradebook',                           templateUrl:'/views/gradebook/gradebook.html',        controller:'GradesCtrl'})
        .state('gradebookdetail', {url:'/courses/{courseId}/gradebook/{studentId}',               templateUrl:'/views/gradebook/gradebook_detail.html', controller:'GradebookDetailCtrl'})
